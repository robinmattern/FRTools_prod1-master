...
##RFILE    +====================+=======+=================+======+===============+
##FD   RSS21-FileList.sh        |   9479| 10/08/18  1:48|   136| v1.5.81008.01
##FD   RSS21_FileList.sh        |  12243| 11/14/22  8:05|   179| v1.07.21114.2005
##FD   RSS21_FileList.sh        |  14263| 12/03/22 13:31|   188| p1.07-21203.1331
##DESC     .--------------------+-------+-----------------+------+---------------+
...
# +------- +------------------ +----------------------------------------------------------- # ------------+ ------------------- # --------------+
    ...
    aVdt="Dec 03, 2022  1:31p"; aVtitle="formR gitR Tools"                                                                      # .(21113.05.6 RAM Add aVtitle for Version in Begin)
