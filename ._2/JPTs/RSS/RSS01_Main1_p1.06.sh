...
#========================================================================================================== #  ===============================  #
     ...
     aVdt="Nov 16, 2022 5:00p"; aVtitle="Robin's Shell Scripts"                                             # .(21113.05.4 RAM Add aVtitle for Version in Begin)
...
#    aFns="$( dirname "${BASH_SOURCE}"         )/RSS01_Main2Fns_p1.06_v21112.sh";  if [ ! -f "${aFns}" ]; then  ##.(21113.05.5 RAM Use RSS01_Main2Fns_p1.06_v21112.sh)
     ...
     echo -e "\n ** RSS01[ 43]  JPT Fns script, '.${aFns#*._2}', NOT FOUND\n"; exit; fi; #fi
     source "${aFns}";
...
#    sayMsg    "RSS01[110]  aServer: '${aServer}', aOSv: ${aOSv}, aOS: '${aOS}', bDebug: '${bDebug}'" 1
#    sayMsg    "RSS01[111]  $\1: '$1', $\2: '$2', $\3: '$3', $\4: '$4', bQuiet: '${bQuiet}', bDebug: '${bDebug}'" 2
